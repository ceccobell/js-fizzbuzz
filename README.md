...
1. che costrutto posso usare per stampare i numeri da 1 a 100? ----> for
2. ho fatto il for ora devo capire come capire se un numero è un multiplo di x -----> uso %
3. ho capito come trovare i multipli ora uso un if per impostare le condizioni
4. stampo i valori
